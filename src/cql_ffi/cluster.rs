...
impl Cluster {
    ...
    pub fn new() -> Cluster { unsafe { Cluster(cass_cluster_new()) } }
    ...
    pub fn connect(&mut self) -> Result<Session, CassError> { Session::new().connect(&self).wait() }
