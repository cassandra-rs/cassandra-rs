...
use cql_bindgen::CassCustomPayload as _CassCustomPayload;
use cql_ffi::policy::retry::RetryPolicy;
use cql_ffi::consistency::Consistency;
use cql_bindgen::cass_custom_payload_free;
use cql_bindgen::cass_custom_payload_new;
use cql_bindgen::cass_custom_payload_set;
...
impl CustomPayload {
    pub fn new() -> Self { unsafe { CustomPayload(cass_custom_payload_new()) } }
...
impl Batch {
    ...
    pub fn new(batch_type: BatchType) -> Batch { unsafe { Batch(cass_batch_new(batch_type as u32)) } }
