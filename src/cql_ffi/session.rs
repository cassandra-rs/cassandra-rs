...
use cql_ffi::schema::schema_meta::SchemaMeta;
use cql_ffi::metrics::SessionMetrics;
...
impl Drop for Session {
    ...
    fn drop(&mut self) { unsafe { cass_session_free(self.0) } }
}
...
impl Session {
    ...
    pub fn close(self) -> Future { unsafe { Future(cass_session_close(self.0)) } }
    ...
    ///previous call.
    pub fn get_schema_meta(&self) -> SchemaMeta { unsafe { SchemaMeta(cass_session_get_schema_meta(self.0)) } }
