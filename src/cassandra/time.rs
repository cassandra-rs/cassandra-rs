...
use cassandra_sys::CassTimestampGen as _CassTimestampGen;
...
impl TimestampGen {
    pub fn from_epoch(epoch_seconds: i64) -> i64 {
        unsafe { cass_time_from_epoch(epoch_seconds) }
    }
...
pub fn date_time_from_epoch(date: u32, time: i64) -> i64 {
    unsafe { cass_date_time_to_epoch(date, time) }
}
